...
LIVE_GROUPS = OrderedDict(
    [
        ('Panhellenic', 30201), ('International', 30203), ('Pancypriot', 30202), ('Toronto Channels', 30209),
        ('Music', 30125), ('Thematic', 30208), ('Regional', 30207), ('AliveGR Cinema', 30342), ('Kids', 30032),
        ('Cinema', 30205), ('Misc', 30206), ('Web TV', 30210), ('Sports', 30094)
    ]
)
