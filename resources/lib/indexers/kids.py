        ...
        self.data = [
            {
                ...
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL4075DA390F6E82B1/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/MPtZ_VHNg34/mqdefault.jpg'
            }
            ,
            {
                'title': 'Collection Miscellaneous 2 - Συλλογή Διάφορα 2'.decode('utf-8'),
                'url': '{0}/channel/UCzU4decItAYA0omjxNiIHbg/playlists/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PLF0A5359586D57FE8/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/X9RxumkELfE/mqdefault.jpg'
            }
            ,
            {
                'title': 'Mythology - Μυθολογία'.decode('utf-8'),
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL3E1C926284F12F32/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/kpd-Z_VK6Jc/mqdefault.jpg'
            }
            ,
            {
                'title': 'Aesop\'s Fables - Αισώπου Μύθοι'.decode('utf-8'),
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL4FF9F773D3596E60/'.format(yt_url),
        ...
        self.data = [
            {
                ...
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL7Adbo89X3LRboPyGr30sIRMnc20C77ui/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL7Adbo89X3LQvxn7RyUySvQy6C6hTUTXf/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL7Adbo89X3LRy-LRQEeRdT_kf5iFdofsu/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeThKG7GK1k2DRgB5im-vPHc/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/5nEDQ_jYJIo/mqdefault.jpg'
            }
            ,
            {
                'title': 'The land of Knowledge - Η Χώρα των Γνώσεων'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeS-ZVlk0vgNdx5igsFvYN8s/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/K-Ba9l2uDDk/mqdefault.jpg'
            }
            ,
            {
                'title': 'Ancient Egypt - Αρχαία Αίγυπτος'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeTrRcdIHjtziNEkqPqalUOa/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/pV8EMy8gaXI/mqdefault.jpg'
            }
            ,
            {
                'title': 'Explorers & Seafarers - Εξερευνητές και Θαλασσοπόροι'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeQRBb7ayyynWgYEUbkQKPpJ/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/SPdnnVNZgwc/mqdefault.jpg'
            }
            ,
            {
                'title': 'Mini Encyclopaedia - Μικρή Εγκυκλοπαίδεια'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeTLMi1bFqLC_cn5ZAtqSvlV/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/o31_SNQFYhc/mqdefault.jpg'
            }
            ,
            {
                'title': 'Miscellaneous Documentaties - Διάφορα Ντοκυμαντέρ'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeRY94Yga82ZYsPJ9Xbe3OiZ/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/Vf_o_Q5ZQRg/mqdefault.jpg'
            }
            ,
            {
                'title': 'Learn Ancient Greek - Μάθετε Αρχαία Ελληνικά'.decode('utf-8'),
                'url': '{0}/channel/UC5quWsvOBNUaR-Duv3K-JFA/playlist/PLxqCshQO3A1HnlHwxda3wX_kzY-C0gpZq/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/st01jb_Xb7g/mqdefault.jpg'
            }
            ,
            {
                'title': 'Drawings - Ζωγραφιές'.decode('utf-8'),
                'url': '{0}/channel/UC5quWsvOBNUaR-Duv3K-JFA/playlist/PLxqCshQO3A1FmjzGXbfIjTSXcysLfPfKM/'.format(yt_url),
    ...
    def kids_songs(self):
        ...
        self.data = [
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCUmGu9Ncu5NeaEjwpLXW0PQ/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCyENiZwRYzfXzbwP-Mxk9oA/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL7Adbo89X3LQJIp9hY-4ESH6P1PVW34uB/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/WhQy0aZ22Tc/mqdefault.jpg'
            }
            ,
            {
                'title': 'The party\'s songs - Τα τραγούδια της παρέας'.decode('utf-8'),
                'url': '{0}/channel/UCsKQX1G7XQO2a5nD9nrse-Q/playlist/PL7Adbo89X3LRsQ-umYdnXPrTzclN0vsPh/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/V1pdBZaF3cc/mqdefault.jpg'
            }
            ,
            {
                'title': 'Greek Karaoke - Ελληνικό Καραόκε'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeRlD0w1GXbitRL6sbyMscVi/'.format(yt_url),
            ...
            ,
            {
                ...
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeSL-M5Q0qG3Eszj0I1O98bT/'.format(yt_url),
                'icon': 'https://i.ytimg.com/vi/L2atYpQ7Zbg/mqdefault.jpg'
            }
            ,
            {
                'title': 'Learning Music for Kids - Μαθαίνω Μουσική, για παιδιά'.decode('utf-8'),
                'url': '{0}/channel/UCp_0VMwvn5LeJMhtreBFIcA/playlist/PLP25S0MkvCeRr5VH-HylSX89MHXQ_KyS0/'.format(yt_url),
