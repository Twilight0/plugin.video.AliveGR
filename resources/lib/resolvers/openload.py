...
def get_video_openload(link):
    ...
    return url + client.spoofer(age_str=cache.get(client.randomagent, 6), referer=True, ref_str=link)
...
def decode(code, parseInt, _0x59ce16, _1x4bfb36):
    ...
    url = "https://openload.co/stream/{0}?mime=true".format(_0x1bf6e5)
    return url
